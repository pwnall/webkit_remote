...
# -*- encoding: utf-8 -*-
# stub: webkit_remote 0.6.0 ruby lib

Gem::Specification.new do |s|
  s.name = "webkit_remote".freeze
  s.version = "0.6.0"
  ...
  s.date = "2017-06-25"
  s.description = "Launches Google Chrome instances and controls them via the Remote Debugging server".freeze
  ...
  s.homepage = "http://github.com/pwnall/webkit_remote".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.10".freeze
  s.summary = "Client for the Webkit Remote Debugging server".freeze

  if s.respond_to? :specification_version then
    s.specification_version = 4

    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<ws_sync_client>.freeze, [">= 0.1.2"])
      ...
      s.add_development_dependency(%q<puma>.freeze, [">= 2.8.0"])
      s.add_development_dependency(%q<rack>.freeze, [">= 1.6.8"])
      s.add_development_dependency(%q<rack-contrib>.freeze, [">= 1.2.0"])
      s.add_development_dependency(%q<rdoc>.freeze, [">= 4.1.1"])
      s.add_development_dependency(%q<simplecov>.freeze, [">= 0.9.1"])
      s.add_development_dependency(%q<yard>.freeze, [">= 0.8.7.3"])
    else
      s.add_dependency(%q<ws_sync_client>.freeze, [">= 0.1.2"])
      ...
      s.add_dependency(%q<puma>.freeze, [">= 2.8.0"])
      s.add_dependency(%q<rack>.freeze, [">= 1.6.8"])
      s.add_dependency(%q<rack-contrib>.freeze, [">= 1.2.0"])
      s.add_dependency(%q<rdoc>.freeze, [">= 4.1.1"])
      s.add_dependency(%q<simplecov>.freeze, [">= 0.9.1"])
      s.add_dependency(%q<yard>.freeze, [">= 0.8.7.3"])
    end
  else
    s.add_dependency(%q<ws_sync_client>.freeze, [">= 0.1.2"])
    s.add_dependency(%q<bundler>.freeze, [">= 1.5.3"])
